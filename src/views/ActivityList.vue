...
export default {
  ...
  data() {
    return {
      ...
      guideSteps: [
        {
          title: '活动列表页介绍',
          content: '这里是活动列表页面，您可以查看和管理平台的所有活动。',
          order: 1
        },
        {
          title: '筛选功能',
          content: '使用这些筛选条件可以快速找到您需要的活动。支持关键词搜索、状态筛选、时间范围、类型筛选等。',
          order: 2
        },
        {
          title: '统计信息',
          content: '这里展示了活动的整体统计数据，包括总活动数、进行中、即将开始等。',
          order: 3
        },
        {
          title: '列表工具栏',
          content: '这里可以查看搜索结果，调整每页显示数量，切换视图模式。',
          order: 4
        },
        {
          title: '活动列表项',
          content: '每个列表项包含活动的基本信息，点击可以查看详情，点击编辑按钮可以修改活动信息。',
          order: 5
        },
        {
          title: '分页功能',
        ...
        {
          title: '详情查看',
          content: '点击列表项或"查看详情"按钮可以打开详情对话框，查看活动完整信息。',
          order: 7
        },
        {
          title: '编辑功能',
          content: '在详情对话框中可以切换到编辑模式，修改活动信息并保存。',
          order: 8
        }
      ]
    }
  ...
  methods: {
        checkGuide() {
      // 检查是否已经看过引导
      const hasSeen = localStorage.getItem('guide_seen_activity-list-guide')
      if (!hasSeen) {
        // 延迟显示，让页面先加载完成
        setTimeout(() => {
          this.showGuide = true
